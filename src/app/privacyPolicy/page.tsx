                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="prose prose-lg max-w-none">
                            ...
                            <p className="mb-4">
                                ...
                                visita nosso website ou utiliza nossos produtos
                                e serviços.
                            </p>
                            <p className="mb-6">
                            ...
                            <ul className="list-disc pl-6 mb-6">
                                ...
                                <li className="mb-2">
                                    <strong>Informações de uso:</strong> Como
                                    você interage com nosso site e serviços,
                                    preferências de conteúdo e comunicação.
                                </li>
                                <li className="mb-2">
                                    <strong>Informações técnicas:</strong>{" "}
                                    Endereço IP, tipo de navegador, provedor de
                                    serviços de internet, páginas de
                                    referência/saída e carimbos de data/hora.
                                </li>
                            </ul>
                            ...
                            <ul className="list-disc pl-6 mb-6">
                                <li className="mb-2">
                                    Fornecer, manter e melhorar nossos produtos
                                    e serviços;
                                </li>
                                <li className="mb-2">
                                ...
                                <li className="mb-2">
                                    Enviar informações técnicas, atualizações e
                                ...
                                <li className="mb-2">
                                    Personalizar sua experiência com nosso site
                                    e serviços.
                                </li>
                            </ul>
                            ...
                            <p className="mb-6">
                                ...
                                coletar informações sobre suas atividades de
                                navegação. Você pode controlar o uso de cookies
                            ...
                            <p className="mb-6">
                                ...
                                alteração, divulgação ou destruição. No entanto,
                                nenhum método de transmissão pela internet ou
                            ...
                            <ul className="list-disc pl-6 mb-6">
                                <li className="mb-2">
                                    Acessar os dados pessoais que mantemos sobre
                                    você;
                                </li>
                                <li className="mb-2">
                                ...
                                <li className="mb-2">
                                    Apresentar uma reclamação a uma autoridade
                            ...
                            <p className="mb-6">
                                ...
                                periodicamente. A versão mais recente estará
                                sempre disponível em nosso site, com a data da
                                última atualização.
                            </p>
